        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('minlength') && value) {
                ...
                if (value.length < minLength) {
                    showError(field, `يجب أن يكون ${minLength} أحرف على الأقل`);
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                setTimeout(function() {
                    ...
                    if (submitBtn) {
                        ...
                        submitBtn.textContent = submitBtn.getAttribute('data-original-text') || 'تم الإرسال';
                    }
                    
                    const successMsg = document.createElement('div');
                    successMsg.className = 'success-message';
                    successMsg.textContent = 'تم إرسال رسالتك بنجاح!';
                    successMsg.style.cssText = 'color: #38a169; padding: 1rem; text-align: center; font-weight: bold;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8deab7f7-7161-46cc-a537-a04d23082cfb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8deab7f7-7161-46cc-a537-a04d23082cfb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8deab7f7-7161-46cc-a537-a04d23082cfb';
